...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary:
      "bg-brand-primary text-brand-dark hover:bg-brand-primary/95 shadow-glass-emerald focus:ring-brand-primary",
    secondary:
      "bg-brand-secondary text-brand-dark hover:bg-brand-secondary/90 focus:ring-brand-secondary",
    danger: "bg-brand-error text-white hover:bg-brand-error/90 focus:ring-brand-error",
    outline:
      "border border-brand-border text-brand-text hover:bg-slate-800/40 focus:ring-slate-700",
  };
